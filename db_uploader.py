...
with transaction.atomic() :
    with open(CSV_PATH_PRODUCTS) as in_file :
        ...
        for row in data_reader :
            ...
            if row[9] :
                thumbnail = row[9]
                Product.objects.create(name=product_name, menu_id=menu_id, category_id=category_id ,price=price, description=description, quantity=quantity, thumbnail_image_url=thumbnail)